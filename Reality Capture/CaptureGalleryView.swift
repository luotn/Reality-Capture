...
struct CaptureGalleryView: View {
    ...
    var body: some View {
        ...
        .navigationTitle(Text("\(captureFolderState.captureDir?.lastPathComponent ?? String(localized: "NONE"))"))
        ...
        if usingCurrentCaptureFolder {
            Menu(content: {
                Button(action: {
                    ...
                    Label(String(localized: "New Session"), systemImage: "camera")
                }
            }, label: {
