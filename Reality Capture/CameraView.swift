...
struct CameraView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle(Text(String(localized: "Scan")))
            .navigationBarTitle(String(localized: "Scan"))
...
//                    NavigationLink(destination: PhotogrammetryView()) {
...
//                }
            ...
            if showInfo {
                Text(String(localized: "Current Capture Info"))
                    .font(.caption)
                    .onTapGesture {
    ...
    var body: some View {
        VStack(alignment: .center/*@END_MENU_TOKEN@*/, spacing: 2) {
            ...
            if case .automatic = model.captureMode {
                Text(String(localized: "Auto Capture"))
                    .font(.caption)
