...
struct InfoPanelView: View {
    ...
    var body: some View {
        VStack {
            ...
            Spacer(minLength: 18)
            HStack {
                Text(String(localized: "Captures: ") + String(model.captureFolderState!.captures.count))
...
struct CameraStatusLabel: View {
    ...
    var body: some View {
        if enabled && qualityMode {
            ...
            Text(String(localized: "High Quality")).foregroundColor(.secondary).font(.caption)
        } else if enabled {
            Image(systemName: "exclamationmark.circle").foregroundColor(Color.yellow)
            Text(String(localized: "Low Quality")).foregroundColor(.secondary).font(.caption)
        } else {
            Image(systemName: "xmark.circle").foregroundColor(Color.red)
            Text(String(localized: "Unavailable")).foregroundColor(.secondary).font(.caption)
        }
    }
}
...
struct GravityStatusLabel: View {
    ...
    var body: some View {
        ...
        Text(String(localized: "Gravity Info")).font(.caption).foregroundColor(Color.secondary)
    }
}
...
struct DepthStatusLabel: View {
    ...
    var body: some View {
        ...
        Text(String(localized: "Depth")).font(.caption).foregroundColor(.secondary)
    }
}
